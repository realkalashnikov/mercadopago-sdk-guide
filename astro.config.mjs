  ...
  integrations: [
    ...
    starlight({
      ...
      social: [
        {
          icon: "github",
          label: "GitHub",
          href: "https://github.com/realkalashnikov/mercadopago-sdk-guide",
        },
      ],
      ...
      sidebar: [
        {
          label: "Início",
          items: [{ label: "Introdução", slug: "introducao" }],
        },
        {
          ...
          items: [
            ...
            {
              label: "4. Checkout Transparente",
              slug: "checkout-transparente",
            },
            {
              label: "5. Cobrando Taxas (Marketplace)",
